    ...
    <div className="h-full flex flex-col bg-[#0a0a0a]">
      ...
      <div className="h-12 shrink-0 flex items-center justify-between px-4 border-b border-[#2a2a2a]">
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 rounded-lg bg-[#1DB954]/10 border border-[#1DB954]/20 flex items-center justify-center">
            <Music className="h-4 w-4 text-[#1DB954]" />
          </div>
          <span className="font-semibold text-[#f0f0f0]">Spotify</span>
        </div>
        <Button asChild size="sm" className="bg-[#1DB954] hover:bg-[#1DB954]/90 text-white h-8 gap-1.5">
      ...
      <div className="flex-1 bg-[#0a0a0a] relative">
        {loading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-sm text-[#888888]">Loading Spotify…</p>
          </div>
        )}
        <iframe
